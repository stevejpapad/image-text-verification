...
🤗 **UPDATE (July 2026):** Because many of the original image URLs are no longer accessible, the raw images are provided on [Hugging Face](https://huggingface.co/datasets/stefpapad/X-POSE). Access requires an official academic or research institution email address for verification.
